      ...
      <td className="px-8 py-6">
        <div className="flex items-center gap-6">
          <div className="relative w-12 h-12 rounded-xl bg-card border border-border overflow-hidden shrink-0 shadow-xl transition-all group-hover:border-accent">
             {jogador.fotoUrl ? <img src={jogador.fotoUrl} alt={jogador.nomePopular} className="w-full h-full object-cover" /> : <Shield className="w-5 h-5 m-auto mt-3 text-muted relative z-10" />}
          </div>
              ...
              {jogadoresFiltrados.map(j => (
                ...
                >
                  ...
                  <div className="w-32 h-32 rounded-xl overflow-hidden bg-background border border-border shadow-md mb-6 group-hover:scale-105 transition-transform relative">
                    ...
                    {j.fotoUrl ? <img src={j.fotoUrl} alt={j.nomePopular} className="w-full h-full object-cover transition-all duration-700" /> : <UserPlus className="w-10 h-10 m-auto mt-10 text-muted relative z-10" />}
                  </div>
