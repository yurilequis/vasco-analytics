...
var scraping_service_1 = require("./src/scraping/scraping.service");
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, scrapingService;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, core_1.NestFactory.createApplicationContext(app_module_1.AppModule)];
                case 1:
                    app = _a.sent();
                    scrapingService = app.get(scraping_service_1.ScrapingService);
                    console.log('Iniciando scrape de partidas...');
                    return [4 /*yield*/, scrapingService.scrapePartidas()];
                case 2:
                    _a.sent();
